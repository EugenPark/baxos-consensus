...
var file_common_definitions_proto_rawDesc = []byte{
	...
	0x68, 0x52, 0x0c, 0x64, 0x65, 0x63, 0x69, 0x64, 0x65, 0x64, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x12,
...
var file_common_definitions_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_common_definitions_proto_goTypes = []any{
	...
	(*PromiseReply)(nil),    // 6: PromiseReply
	(*DecideInfo)(nil),      // 7: DecideInfo
	(*ProposeRequest)(nil),  // 8: ProposeRequest
	(*AcceptReply)(nil),     // 9: AcceptReply
}
var file_common_definitions_proto_depIdxs = []int32{
	...
	4,  // 2: PrepareRequest.prepare_ballot:type_name -> Ballot
	4,  // 3: PromiseReply.last_promised_ballot:type_name -> Ballot
	4,  // 4: PromiseReply.last_accepted_ballot:type_name -> Ballot
	2,  // 5: PromiseReply.last_accepted_value:type_name -> ReplicaBatch
	2,  // 6: PromiseReply.decided_value:type_name -> ReplicaBatch
	2,  // 7: DecideInfo.decided_value:type_name -> ReplicaBatch
	4,  // 8: ProposeRequest.propose_ballot:type_name -> Ballot
	2,  // 9: ProposeRequest.propose_value:type_name -> ReplicaBatch
	7,  // 10: ProposeRequest.decide_info:type_name -> DecideInfo
	4,  // 11: AcceptReply.accept_ballot:type_name -> Ballot
	2,  // 12: AcceptReply.decided_value:type_name -> ReplicaBatch
